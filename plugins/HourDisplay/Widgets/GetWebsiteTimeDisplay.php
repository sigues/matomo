 ...
 *
 */
namespace Piwik\Plugins\HourDisplay\Widgets;
 ...
 */
class GetWebsiteTimeDisplay extends Widget
{
    public static function configure(WidgetConfig $config)
    {
         ...
         */
        $config->setName('HourDisplay_WebsiteTimeDisplay');
    ...
    {
        $websiteId = Common::getRequestVar('idSite', null, 'int');
        $timezone = Site::getTimezoneFor($websiteId);

        return $this->renderTemplate('websiteTimeDisplay', [
            'timezone' => $timezone
        ]);
    }
